class SignupLeadsController < ApplicationController
  ...
  private
    ...
    def signup_lead_params
      params.require(:signup_lead).permit(:email, :first_name, :last_name, :company_name, :phone, :company_industry, :company_old, :company_employees, :meeting_date, :meeting_time, :ispending, :isfollowup, :isproduction, :pricing_plan, :pricing_options, :email_instead)
    end
end
